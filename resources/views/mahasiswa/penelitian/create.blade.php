		...
		<div class="">
			...
			<form id="tambahPenelitian" method="post" action="{{url('/mahasiswa/penelitian/create')}}" enctype="multipart/form-data"  class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="fakultas" name="fakultas" placeholder="Masukkan Fakultas" value="{{$fakultas_mhs->nama_fakultas}}" readonly="readonly">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						...
						<p class="help-block">*contoh: DIPA Universitas Negeri Surabaya</p>
