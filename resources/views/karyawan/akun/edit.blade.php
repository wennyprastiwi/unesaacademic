		...
		<div class="">
			...
			<form id="editAkun" method="post" action="{{url('/karyawan/akun/'.$akun->nim.'/edit')}}" enctype="multipart/form-data"  class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<select class="form-control input-lg" id="fakultas" name="fakultas" placeholder="Masukkan ID Fakultas" required>
						@foreach ($fakultas as $f)
						<option value="{{$f->id_fakultas}}">{{$f->nama_fakultas}}</option>
						@endforeach 
						<option value="000000">--Belum ada fakultas--</option>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="program-studi" name="program-studi" placeholder="Program Studi" value="{{$akun->prodi}}" required>
					</div>
				</div>
