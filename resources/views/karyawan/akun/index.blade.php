  ...
  <tbody>
   @forelse($akunmahasiswa as $i => $bio) 
    <tr>
      ...
      @if (($bio->id_fakultas)!= '')
      <td width="10%" style="text-align:center">{{$bio->nama_fakultas}}</td>
      @else
      <td width="10%" style="text-align:center">Belum ada fakultas</td>
      @endif
      <td width="15%" style="text-align:center">{{$bio->prodi}}</td>
