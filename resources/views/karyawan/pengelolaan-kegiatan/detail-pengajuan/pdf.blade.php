<table style="width:100%; border: 0px;">
    <tr>
        <td style="width:30%"><img style="width:50%;" align="middle" alt="logo-unesa" src="https://image.psikolif.com/logo-unesa/"></td>
        <td><h1 style="text-align:center">UNIVERSITAS NEGERI SURABAYA</h1></td>
    </tr>
</table>
<style type="text/css">
table {
