...
class AkunMahasiswaController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        $mahasiswa->id_fakultas = $request->input("fakultas");
        $mahasiswa->prodi = $request->input("program-studi");
        $mahasiswa->save();
   ...
   public function edit($nim)
    ...
    public function editAction($nim, Request $request)
    {
        ...
        $akunmahasiswa->id_fakultas = $request->input("fakultas");
        $akunmahasiswa->prodi = $request->input("program-studi");
